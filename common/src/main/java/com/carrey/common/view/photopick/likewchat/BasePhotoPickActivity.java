...
import com.carrey.common.util.AnimationUtil;
import com.carrey.common.util.BaseConstant;
import com.carrey.common.util.UIUtil;
import com.carrey.common.view.photopick.likewchat.adapter.AlbumAdapter;
import com.carrey.common.view.photopick.likewchat.adapter.PhotoSelectorAdapter;
...
public class BasePhotoPickActivity extends CommonAct implements PhotoSelectorAdapter.onItemClickListener, PhotoSelectorAdapter.onPhotoItemCheckedListener
        , View.OnClickListener {

    public static final String EXTRA_PARAM = "param";

    private RecyclerView mGvPhotos;
    private RecyclerView lvAblum;
...
//    private TextView mRightText;
    ...
    protected void initViews() {
        ...
        mGvPhotos = (RecyclerView) findViewById(R.id.gv_photos_ar);
        lvAblum = (RecyclerView) findViewById(R.id.lv_ablum_ar);
...
//        TitleBar.TextAction action = new TitleBar.TextAction("确定(0)") {
//
//            @Override
...
//        mRightText = (TextView) mTitleBar.getViewByAction(action);
...
//        mRightText.setText("确定(" + mSelectPhotos.size() + ")");
