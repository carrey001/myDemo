...
import com.carrey.common.view.MenuDialog;
...
public class UIUtil {
    ...
    public static Dialog showProgressBar(Activity activity, String msg) {
        ...
        ///显示宽度为屏幕的4/5
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(SystemUtil.getScreenWidth() / 2,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        TextView tvMsg = (TextView) view.findViewById(R.id.txtv_loading_text);
...
//        animator.setRepeatCount(-1);
    ...
    public static void showEmptyView(ViewGroup parent, String emptyStr, int resId, View.OnClickListener
            onClickListener) {
        View emptyView = getNoticeView(parent, parent.getResources().getDrawable(resId == 0 ?
                R.mipmap.ic_no_data : resId), emptyStr, ID_EMPTY_VIEW);
    ...
    public static void showErrorView(ViewGroup parent, String emptyStr, View.OnClickListener onClickListener) {
        Drawable drawable = parent.getResources().getDrawable(R.mipmap.ic_network_failed);
     ...
     * @param onClickListener 控件点击事件
     */
    public static void showErrorView(ViewGroup parent, View errorView,
    ...
    private static void addNoticeView(ViewGroup parent, View child, int tag, View.OnClickListener listener) {
        ...
        parent.addView(child, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
     ...
     * @param okListener
     */
    public static Dialog showConfirm(Context context, String title, String msg, String okStr, final View.OnClickListener okListener) {
     ...
     * @param okListener
     */
    public static Dialog showConfirm(Context context, String title, String msg, final View.OnClickListener okListener) {
    ...
    public static Dialog showConfirm(final Context context, String title, String msg, String okStr,
                                     final View.OnClickListener okListener, String cancelStr,
    ...
    public static Dialog showAlert(final Context context, String msg) {
        return showAlert(context, "提示", msg, "确定", null);
    }
    ...
    public static Dialog showAlert1(final Context context, View view) {
        final Dialog dialog = showAlert(context, view);
        Button btn_confirm_right = (Button) view.findViewById(R.id.btn_confirm_right);
        setTouchEffect(btn_confirm_right);
