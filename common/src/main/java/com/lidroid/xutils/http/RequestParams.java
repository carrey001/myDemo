...
import com.lidroid.xutils.http.client.entity.JsonTextEntity;
...
public class RequestParams {
    ...
    public static final String TYPE_URL_ENCODE = URLEncodedUtils.CONTENT_TYPE;
    ...
    public List<BodyFileItem> fileParams;
...
//            this.headers.add(new HeaderItem(header, true));
    ...
    public void addBodyMapParameter(Map<String, String> map) {
        if (bodyParams == null) {
        ...
        if(map != null){
            for (String key : map.keySet()) {
                addBodyParameter(key, map.get(key));
            }
        }
    }
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new FileBody(file)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new FileBody(file, mimeType)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new FileBody(file, mimeType, charset)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new FileBody(file, fileName, mimeType, charset)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new InputStreamBody(stream, length)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new InputStreamBody(stream, length, fileName)));
...
//            fileParams = new HashMap<String, ContentBody>();
        ...
        fileParams.add(new BodyFileItem(key, new InputStreamBody(stream, length, fileName, mimeType)));
//        fileParams.put(key, new InputStreamBody(stream, length, fileName, mimeType));
    ...
    public HttpEntity getEntity() {
        ...
        if (TYPE_MULTI_PART.equals(contentType) || fileParams != null && !fileParams.isEmpty()) {
            ...
            if (fileParams != null && !fileParams.isEmpty()) {
                for (BodyFileItem item : fileParams) {
                    multipartEntity.addPart(item.name, item.body);
                }
...
//                }
    ...
    public class BodyFileItem {
        public String name;
        public ContentBody body;

        public BodyFileItem(String name, ContentBody body) {
            this.name = name;
            this.body = body;
        }
    }
