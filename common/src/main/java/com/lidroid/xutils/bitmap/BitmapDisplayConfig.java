...
public class BitmapDisplayConfig {
    ...
    // chenbo add
    private boolean onlyLoadLocal = false;
    ...
    public boolean isOnlyLoadLocal() {
        return onlyLoadLocal;
    }

    public void setOnlyLoadLocal(boolean onlyLoadLocal) {
        this.onlyLoadLocal = onlyLoadLocal;
    }
    ...
    public BitmapDisplayConfig cloneNew() {
        ...
        config.onlyLoadLocal = this.onlyLoadLocal;
        return config;
    }
}
