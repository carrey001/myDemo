...
public class BitmapGlobalConfig {
    ...
    private final static PriorityExecutor CACHE_CTRL_EXECUTOR = new PriorityExecutor(2);
    ...
    private void initBitmapCache() {
        LogUtils.d("bacy->initBitmapCache");
        new BitmapCacheManagementTask().executeOnExecutor(CACHE_CTRL_EXECUTOR, BitmapCacheManagementTask.MESSAGE_INIT_MEMORY_CACHE);
        new BitmapCacheManagementTask().executeOnExecutor(CACHE_CTRL_EXECUTOR, BitmapCacheManagementTask.MESSAGE_INIT_DISK_CACHE);
    }
    ...
    public static class BitmapCacheAdapter implements BitmapCacheListener {
        ...
        @Override
        public void onClearCacheFinished(String uri) {

        }

        @Override
        public void onClearMemoryCacheFinished(String uri) {

        }

        @Override
        public void onClearDiskCacheFinished(String uri) {
